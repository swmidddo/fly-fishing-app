...
const REGULATIONS = {
    NSW: {
        ...
        freshwater: [
            { name: "Murray Cod", minSize: 55, maxSize: 75, bagLimit: "1 (Rivers), 2 (Dams)", possessionLimit: "4", season: "Closed Sept 1 - Nov 30 (except Copeton & Blowering dams)" },
            { name: "Golden Perch", minSize: 30, maxSize: null, bagLimit: "5", possessionLimit: "10", season: "Open all year" },
            { name: "Rainbow Trout", minSize: 25, maxSize: null, bagLimit: "5 in dams/lakes, 2 in streams", possessionLimit: "10", season: "Closed in streams June long weekend - Oct long weekend" },
            { name: "Brown Trout", minSize: 25, maxSize: null, bagLimit: "5 in dams/lakes, 2 in streams", possessionLimit: "10", season: "Closed in streams June long weekend - Oct long weekend" },
            { name: "Brook Trout", minSize: 25, maxSize: null, bagLimit: "5 in dams/lakes, 2 in streams", possessionLimit: "10", season: "Closed in streams June long weekend - Oct long weekend" },
            { name: "Australian Bass", minSize: 0, maxSize: null, bagLimit: "2 (only 1 over 35cm)", possessionLimit: "4", season: "Closed in rivers June 1 - Aug 31" },
            { name: "Estuary Perch", minSize: 0, maxSize: null, bagLimit: "2 (only 1 over 35cm, combined with Bass)", possessionLimit: "4", season: "Closed in rivers June 1 - Aug 31" },
            { name: "Silver Perch", minSize: 30, maxSize: null, bagLimit: "5 (Stocked dams only)", possessionLimit: "10", season: "Rivers closed all year (protected in rivers)" },
            { name: "Trout Cod", minSize: "Protected", maxSize: "N/A", bagLimit: "0", possessionLimit: "0", season: "Protected species. Catch & release only, return to water immediately" },
            { name: "Eastern Freshwater Cod", minSize: "Protected", maxSize: "N/A", bagLimit: "0", possessionLimit: "0", season: "Protected. Total closure in all waters, illegal to target" },
            ...
            { name: "Redfin Perch", minSize: "No Limit (Pest)", maxSize: "N/A", bagLimit: "Unlimited", possessionLimit: "Unlimited", season: "Pest species. Do not return to water alive" }
        ],
        saltwater: [
            { name: "Dusky Flathead", minSize: 36, maxSize: 70, bagLimit: "5", possessionLimit: "10", season: "Open all year (All fish > 70cm must be released)" },
            { name: "Yellowfin Bream", minSize: 25, maxSize: null, bagLimit: "10", possessionLimit: "20", season: "Open all year" },
            { name: "Snapper", minSize: 30, maxSize: null, bagLimit: "10 (only 1 over 70cm)", possessionLimit: "20", season: "Open all year" },
            ...
            { name: "Silver Trevally", minSize: 30, maxSize: null, bagLimit: "10 (combined)", possessionLimit: "20", season: "Open all year" },
    ...
    VIC: {
        stateName: "Victoria",
        freshwater: [
            { name: "Murray Cod", minSize: 55, maxSize: 75, bagLimit: "1 (Rivers), 2 (Lakes)", possessionLimit: "4", season: "Closed Sept 1 - Nov 30 (except Lake Eildon & Blowering)" },
            { name: "Golden Perch", minSize: 30, maxSize: null, bagLimit: "5", possessionLimit: "10", season: "Open all year" },
